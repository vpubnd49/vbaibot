...
export type ToolDefinition = {
   ...
   * Mặc định true - phải khai TƯỜNG MINH false mới bị loại.
   */
  runsInScheduledTurn?: boolean;
  /**
   * Trạng thái bật mặc định khi tạo mới tài khoản/agent (mặc định true).
   * Tool thử nghiệm hoặc có quota nhạy cảm đặt false để tránh tự động bật diện rộng.
   */
