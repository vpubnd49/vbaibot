...
export const TUNING_GROUPS: TuningGroup[] = [
  ...
  {
    id: "documents",
    title: "Tài liệu & Trình chiếu",
    navHint: "Word, Excel, PowerPoint, PDF",
    hint: "Cấu hình đọc tệp tải lên (.docx, .pdf, .xlsx, scan OCR) và các giới hạn tạo tệp (.docx NĐ 30, .pptx, .xlsx).",
  },
  {
    id: "knowledge",
    title: "Tri thức dùng chung",
    navHint: "Kiến thức toàn hệ thống",
    hint: "Tri thức đã duyệt được inject vào mọi cuộc trò chuyện — luật mới, quy trình nội bộ, đính chính.",
  },
  {
    id: "images",
    title: "Vẽ ảnh",
...
const TUNING_BY_KEY = {
  ...
  DOCUMENT_MAX_SHEETS: {
    ...
    hint: "Trần số lượng sheet cho một file bảng tính Excel.",
    min: 1,
    max: 50,
    unit: "sheet",
  },
  ...
  SHARED_KNOWLEDGE_MAX_ITEMS: {
    ...
    group: "knowledge",
    label: "Trần mục tri thức trong prompt",
    hint: "Số mục tri thức đã duyệt tối đa inject vào system prompt mỗi lượt trả lời. Mỗi mục ≈ 50-100 token.",
    min: 0,
    max: 200,
    unit: "mục",
  },
