...
export function extractTopicKeywords(query = ""): string[] {
  ...
  const topicPatterns = [
    ...
    { keyword: "bao luc gia dinh", topic: "phòng, chống bạo lực gia đình" },
    { keyword: "nha tam lanh", topic: "nơi tạm lánh" },
    { keyword: "tro giup xa hoi", topic: "trợ giúp xã hội" },
    { keyword: "bao tro xa hoi", topic: "bảo trợ xã hội" },
    { keyword: "hon nhan gia dinh", topic: "hôn nhân và gia đình" },
    { keyword: "cong nghe so", topic: "công nghệ số" },
    { keyword: "nha giao", topic: "nhà giáo" },
    { keyword: "tieu chuan quy chuan", topic: "tiêu chuẩn và quy chuẩn kỹ thuật" },
    { keyword: "nang luong nguyen tu", topic: "năng lượng nguyên tử" },
    { keyword: "tiet kiem nang luong", topic: "sử dụng năng lượng tiết kiệm và hiệu quả" },
    { keyword: "chat luong san pham", topic: "chất lượng sản phẩm, hàng hóa" },
    { keyword: "dau tu", topic: "đầu tư" },
    { keyword: "dau thau", topic: "đấu thầu" },
    { keyword: "xay dung", topic: "xây dựng" },
    { keyword: "quy hoach", topic: "quy hoạch" },
    { keyword: "khieu nai", topic: "khiếu nại" },
    { keyword: "to cao", topic: "tố cáo" },
    { keyword: "thanh tra", topic: "thanh tra" },
    { keyword: "xu phat vi pham", topic: "xử phạt vi phạm hành chính" },
    { keyword: "ho tich", topic: "hộ tịch" },
    { keyword: "chung thuc", topic: "chứng thực" },
    { keyword: "giam dinh tu phap", topic: "giám định tư pháp" },
    { keyword: "cong chung", topic: "công chứng" },
  ];
