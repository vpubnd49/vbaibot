    ...
    sections: [
      {
        ...
        paragraphs: [
          "Ngày 12 tháng 09 năm 2026, Lãnh đạo Ủy ban nhân dân tỉnh đã chủ trì cuộc họp rà soát, chỉ đạo tháo gỡ khó khăn, vướng mắc cho các dự án đầu tư; công tác trang bị phương tiện công vụ cấp xã và xử lý nghĩa vụ tài chính đất đai trên địa bàn tỉnh.",
          "Sau khi nghe các Ban Quản lý dự án, lãnh đạo các Sở, ngành báo cáo và ý kiến phát biểu của các đại biểu dự họp, Lãnh đạo UBND tỉnh kết luận và chỉ đạo nguyên tắc:",
          "Toàn bộ các dự án đầu tư công, dự án ngoài ngân sách phải được rà soát, phân nhóm rõ ràng theo từng lĩnh vực (Du lịch, Nông nghiệp, Công nghiệp, Giao thông, Hạ tầng đô thị). Đồng chí lãnh đạo phụ trách lĩnh vực, địa bàn nào thì chịu trách nhiệm trực tiếp chỉ đạo, tháo gỡ khó khăn xuyên suốt từ giai đoạn chuẩn bị đầu tư đến khi hoàn thành quyết toán, không đùn đẩy trách nhiệm.",
        ],
        items: [
          "Phân công đồng chí Hiệp - Tổ trưởng trực tiếp chủ trì, cùng các đồng chí Phó Chủ tịch phụ trách các khối ngành tổ chức làm việc cụ thể với từng chủ đầu tư để giải quyết từng khó khăn, vướng mắc của dự án.",
          ...
          "Đối với các công trình trọng điểm (Dự án Quảng trường Trung tâm giai đoạn 2, tuyến đường kết nối Bình Thuận cũ, cầu Vạn Thắng, khu dân cư KeraTi, khu dân cư Nam Duẩn, các dự án điện gió...): Giao Ban 1, Ban 2, Ban 3 khẩn trương rà soát kỹ lưỡng hồ sơ, tập trung giải quyết dứt điểm các vướng mắc để sớm đưa công trình vào khai thác, phát huy hiệu quả đầu tư.",
        ],
      },
      {
        heading: "II. VỀ TRANG BỊ XE Ô TÔ CÔNG VỤ CẤP XÃ VÀ HỆ THỐNG CAMERA AN NINH",
        paragraphs: [
          ...
          "Yêu cầu về phương án lựa chọn phương tiện: Ưu tiên lựa chọn dòng xe hai cầu chuyên dụng, bền bỉ, chi phí đầu tư hợp lý (dự kiến khoảng 200 triệu đồng/xe hoặc theo đúng khung định mức tiết kiệm), phụ tùng thay thế phổ biến, thuận tiện bảo dưỡng và sửa chữa lâu dài.",
        ],
        items: [
          "Giao Sở Tài chính khẩn trương phối hợp với Sở Nội vụ, Công an tỉnh rà soát hiện trạng phương tiện tại 140 xã, phường; lập danh sách chi tiết các đơn vị còn thiếu phương tiện và các xe ô tô cũ đã hết niên hạn sử dụng để làm thủ tục thanh lý theo đúng quy định.",
          ...
          "Về hệ thống camera an ninh: Thống nhất triển khai xử lý theo phương án đã được đồng chí Nghiên báo cáo; các đơn vị chuyên môn khẩn trương thực hiện bảo đảm tính đồng bộ và kết nối thông suốt.",
        ],
      },
      {
